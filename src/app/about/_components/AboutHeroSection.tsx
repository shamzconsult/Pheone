...
function AboutHeroSection() {
  return (
    <div className='relative overflow-x-hidden h-[750]'>
      ...
      <div className='flex flex-col lg:flex-row gap-8 xl:gap-20'>
        <div className='lg:w-1/2 xl:w-3/5 order-2 lg:order-1 mt-10 lg:mt-32'>
          ...
          <h2 className='text-2xl md:text-3xl lg:text-4xl max-w-3xl font-bold text-[#2c7bbd] tracking-wide mt-6'>
            Embracing <span className='text-black'>Differences,</span> Empowering <span className='text-black'>Potential</span>
          </h2>

          <div className='bg-[#2c7bbd] font-semibold text-white p-4 md:p-6 rounded-2xl max-w-4xl tracking-wide leading-loose mt-6 text-sm md:text-lg'>
          ...
          <p className='max-w-4xl font-semibold tracking-wide leading-loose mt-6 text-sm md:text-lg'>
        ...
        {/* Image  */}
        <div className='lg:w-1/2 xl:w-2/5 order-1 lg:order-2 mt-0 lg:mt-32 flex justify-center lg:justify-end '>
          <img 
            src="/image/Frame 1618873131.png" 
            alt="About us visual" 
            className='w-full max-w-[500px] md:max-w-[600px] lg:max-w-none lg:w-[800px] lg:h-[650px] object-contain'
          />
        </div>
      </div>
    </div>
