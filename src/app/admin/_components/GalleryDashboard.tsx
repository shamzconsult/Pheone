      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-20">
        ...
        <div className="flex justify-between items-center mb-12"> 
          ...
          <div> 
            <button 
              onClick={logout}
              className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-lg shadow-sm transition-colors duration-200 border border-gray-300"
            >
