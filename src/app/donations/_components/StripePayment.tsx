  ...
  if (!error) return '';
    ...
    switch (stripeError.code) {
      ...
      case 'amount_too_small':
        return `Minimum donation is ${selectedCurrency === 'USD' ? '$0.50' : '₦750'}.`;
      case 'invalid_cvc':
      ...
      default:
        return stripeError.message || 'Payment failed. Please check your details and try again.';
    }
    }
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <div className="border border-gray-300 p-2 rounded-lg bg-white">
              <CardExpiryElement options={elementOptions} onChange={handleCardExpiryChange} />
            </div>
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">CVC</label>
            <div className="border border-gray-300 p-2 rounded-lg bg-white">
              <CardCvcElement options={elementOptions} onChange={handleCardCvcChange} />
            </div>
          </div>
        </div>
      </div>
